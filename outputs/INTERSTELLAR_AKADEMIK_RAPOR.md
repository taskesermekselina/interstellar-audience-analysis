...
![Küme Dağılımı Pasta Grafiği](cluster_distribution_pie.png)
...
![Küme Saçılım Grafiği](cluster_scatter.png)
...
![Küme Dağılım Çubuk Grafiği](cluster_distribution.png)
...
![Küme Bazlı Pozitif Negatif Dağılım](cluster_positive_negative_aspects.png)
...
![Özellik Bazlı Genel Duygu](aspect_sentiment.png)
...
![İzleyici Motivasyon Analizi](viewer_motivation_analysis.png)
...
![Platform Karşılaştırması](platform_comparison.png)
